...
import { faChevronLeft, faChevronRight, faSignOutAlt, faFolderOpen } from '@fortawesome/fontawesome-free-solid';
...
export class BPMNStore {
  constructor() {
    ...
    fontawesome.library.add(faChevronLeft, faChevronRight, faSignOutAlt, faFolderOpen);
  }
