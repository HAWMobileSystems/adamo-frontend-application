...
export class ModelComponent {
  ...
  //creates a new model
  public modelCreate() {
    this.apiService.modelCreate(this.selected.modelname, this.selected.modelxml).subscribe(
      (response: { success: any; status: string }) => {
        if (response.success) {
  ...
  public modelDelete() {
    this.apiService.modelDelete(this.selected.mid, this.selected.version).subscribe(
      (response: { success: any; status: string }) => {
        if (response.success) {
