...
export class InputModal {
  private IPIM_VAL = 'IPIM_Val';
  private IPIM_META = 'IPIM_Meta';
  private modeler: any;
  private data: any;
  ...
  public css = false; // public setProps(modeler: any, root: any) {
  ...
  public writeInputModalValues() {
    ...
    const elements = this.data.modeler.get('elementRegistry').getAll(); //Alle Elemente durchlaufen um Variablen zu finden
