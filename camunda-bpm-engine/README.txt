...
(see the LICENSE_BOOK-7.9.0 file).
...
Contents:
  ...
  server/
        ...
        run the
            server/apache-tomcat-9.0.5/bin/startup.{bat/sh}
...
Camunda BPM platform version: 7.9.0
Apache Tomcat Server version: 9.0.5
